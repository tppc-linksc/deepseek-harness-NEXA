...
Visit the [project website](https://www.deepseek-nexa.com) or download the unsigned desktop builds from this fork's [GitHub Releases](https://github.com/tppc-linksc/deepseek-harness-NEXA/releases). See the [desktop release notes](apps/desktop/RELEASE_README.md) before installing.
