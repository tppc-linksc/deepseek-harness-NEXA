...
Locale home projections retain the complete canonical landing-page body while removing its repository-only bilingual switcher. The site navigation owns locale switching, and the [fork desktop landing page](../feature/2026-08-15-fork-desktop-landing-page.md) owns the product and download content rendered at both roots.
