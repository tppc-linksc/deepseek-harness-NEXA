...
来源：[`packages/interaction/qrcode-remote/src/index.ts:41`](../packages/interaction/qrcode-remote/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — 需要 `clientModules` · `connection`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
