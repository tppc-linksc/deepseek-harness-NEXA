...
<div class="nexa-feature-intro"><p class="nexa-section-label">桌面增强</p><h2 id="nexa-desktop-features-title">扩展、更新与遥控，<br>都在 App 内完成。</h2><p>社区扩展、经过校验的桌面更新和端到端加密手机遥控各有清晰入口，不必离开 Harness 工作流。</p></div>
<div class="nexa-feature-grid">
<article class="nexa-feature-card nexa-remote-card"><div class="nexa-feature-heading"><span class="nexa-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="3"></rect><path d="M9 6h6M11 18h2"></path></svg></span><div><small>NEXA Remote</small><h3>远程操控</h3></div></div><p>正式的 <code>qrcode-remote</code> 运行组件会在“设置”旁增加一个紧凑的“连接移动端”图标。点击、使用微信扫描自动生成的小程序码，就会直接继续当前 Harness 会话。小程序用移动端布局镜像桌面消息、紧凑工具摘要、Markdown 结果、运行状态和审批；侧栏只呈现电脑在线状态与工作区/会话，发送与停止永远作用于电脑。</p><div class="nexa-remote-preview" aria-label="连接移动端示意"><div><small>侧边栏</small><strong>连接移动端</strong><span><i></i> 可以扫码</span><p>点击一次 · 微信扫码直达</p></div><b class="nexa-mini-code" aria-hidden="true"></b></div></article>
