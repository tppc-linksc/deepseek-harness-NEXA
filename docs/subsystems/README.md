...
| [desktop.md](desktop.md) | the portless desktop services: isolated extension management, HTTP/SSE compatibility, additive sidebar actions, and visible startup diagnostics |
