...
| [remote-control.md](remote-control.md) | 可选启用的 NEXA 远程操控桥：Relay/E2EE 所有权、电脑确认的二维码配对、手机指令准入、审批回退与设备撤销 |
...
| [desktop.md](desktop.md) | 无端口桌面服务：隔离的扩展管理、HTTP/SSE 兼容、可叠加侧边栏入口与可见启动诊断 |
