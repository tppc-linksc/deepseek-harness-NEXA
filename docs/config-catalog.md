...
Source: [`packages/interaction/remote-control/src/index.ts:38`](../packages/interaction/remote-control/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — requires `clientModules` · `connection` · `subprocess` ([`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts))
