...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopPnpm: 'desktop.md',
  desktopProfiles: 'desktop.md',
  ...
  planMode: 'plan.md',
  remoteControl: 'remote-control.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RemoteControlConfigureRequest: 'remote-control.md',
  RemoteControlPairingOffer: 'remote-control.md',
  RemoteControlRevokeRequest: 'remote-control.md',
  RemoteControlState: 'remote-control.md',
